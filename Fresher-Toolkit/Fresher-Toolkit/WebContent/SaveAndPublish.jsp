...
padding:10px;
 ...
 <div id="tab-container">
   ...
   <%
	...
	stat = con.prepareStatement("select COUNT(*) from batch  where startdate is not NULL and enddate is not NULL and publish=0");
	result = stat.executeQuery();
	result.next();
	int count = result.getInt(1);
	String batchid[] = new String[count]; 		
	stat = con.prepareStatement("select batchid from batch where startdate is not NULL and enddate is not NULL and publish=0");
	result = stat.executeQuery();
	int i=0;
	while(result.next())
	{
 ...
 <div id="form" >
   <center>
   <p style="font-family:arial;color:black;font-size:30px;">Save and Publish Schedule</p>
 ...
 <input type="submit" value="SaveandPublish" >
  </form>
   <%
	...
	alert("Batch Saved and Published successfully! ");
	</script></center>
	  </select>
