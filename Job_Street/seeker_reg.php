...
var a=document.forms["register"]["id"].value;
var b=document.forms["register"]["password"].value;
var c=document.forms["register"]["contact"].value;
var d=document.forms["register"]["dob"].value;
var e=document.forms["register"]["qualification"].value;
var f=document.forms["register"]["exp"].value;
var g=document.forms["register"]["religion"].value;
var h=document.forms["register"]["gender"].value;
var i=document.forms["register"]["address"].value;
var j=document.forms["register"]["country"].value;
if ( x==null || x=="" ||y==null || a==null||b==null || c==null || d==null  || e==null  ||  f==null || g==null  || h==null  ||  i==null ||  j==null || y==""  ||  a=="" || b==""  || c==""  || d==""  ||  e=="" ||  f=="" || g==""  ||  h=="" || i==""  || j=="" )  {
...
<script src="validate/jquery-1.9.1.min.js"></script>
...
if(isset($_POST))
{
$query = "INSERT INTO seeker(sid,fname,lname,contact,email,dob,gender,address,religion,experience,qualification,created,password)
VALUES
('$_POST[id]','$_POST[fname]','$_POST[lname]','$_POST[contact]','$_POST[em]','$_POST[dob]','$_POST[gender]','$_POST[address]','$_POST[religion]','$_POST[exp]','$_POST[qualification]','$_POST[createon]',sha1('$_POST[password]'))";
}
//'$encr'
